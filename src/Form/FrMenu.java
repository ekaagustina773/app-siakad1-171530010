...
public class FrMenu extends javax.swing.JFrame {
    ...
    Connection _Cnn;
    String vid_user, vnama_user, pass, vlev_user;
    String sqlselect;
    ...
    private void aksiLogin(){
        ...
        pass = txtPass.getText().replaceAll("'", "");
        try{
            _Cnn = null;
    ...
    private void initComponents() {
        ...
        mnMKSemester = new javax.swing.JMenuItem();
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addComponent(lbKeterangan, javax.swing.GroupLayout.PREFERRED_SIZE, 476, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        mnMKSemester.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Image/5 - akademik-small.png"))); // NOI18N
        mnMKSemester.setText("Data Mata Kuliah Semester Aktif");
        mnAkademik.add(mnMKSemester);
    ...
    public static void main(String args[]) throws UnsupportedLookAndFeelException,
        ...
        try{
            ...
            //com.jtatto.plaf.mcwin.McWinLookAndFeel.setTheme("Default", "java Swing", "");
            //UIManager.setLookAndFeel("com. jtattoo.plaf.mcwin.McWinLookAndFeel");
    ...
    private javax.swing.JMenuItem mnMKSemester;
